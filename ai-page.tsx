  ...
  return (
    <div>
        ...
        actions={
          <span
            style={{
              ...
              padding: '6px 12px',
              borderRadius: 999,
              background: 'rgba(196,167,102,0.12)',
      ...
      <div className="card" style={{ marginBottom: 22 }}>
        ...
        <p style={{ marginTop: 16, color: 'rgba(245,243,239,0.55)', fontSize: 13 }}>
          Tap the sparkle in the bottom-right to chat.
        </p>
      </div>
      <div
        style={{
          ...
          <div key={f.title} className="card">
            <div
              style={{
                ...
                borderRadius: 12,
                background:
                  'linear-gradient(135deg, rgba(196,167,102,0.25), rgba(196,167,102,0.05))',
                display: 'grid',
                placeItems: 'center',
                marginBottom: 14,
              }}
